# chapter-5-capture-and-bestiary Specification

## Purpose

Defines chapter 5 capture mechanics for the Godot tactics monster demo: downed_capturable wild units, CaptureSystem (rate/tier/attempt), ActionBar capture flow, BestiaryManager, PartyManager reserve, SaveManager persistence, stage ball count, and headless unit test coverage.
