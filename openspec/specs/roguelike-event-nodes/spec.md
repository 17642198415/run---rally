# roguelike-event-nodes

## Purpose

Non-battle roguelike route nodes: rest (heal/sacrifice), shop (seeded purchases), and capture_event (elevated capture-rate battle). Includes NodeHandlers dispatch and supporting data files.
