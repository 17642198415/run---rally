# art-asset-pipeline Specification

## Purpose

Defines the art asset directory layout, naming conventions, `art_manifest.json` index schema, and `ArtLoader` placeholder fallback behavior for seamless swap between generated placeholders and real assets (e.g. Kenney packs).
