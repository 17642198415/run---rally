...
Post-battle reward picker for roguelike runs. Covers the reward pool data, `RewardPool` static utilities, three-card picker UI after elite/BOSS victories, and `RunManager` integration for rolling, persisting, and applying reward choices.
