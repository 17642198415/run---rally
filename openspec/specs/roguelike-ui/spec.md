...
Roguelike mode UI and battle integration for milestone M3: main menu run entry, route map visualization, dual-mode party setup, GameState roguelike battle context, battle scene routing, run summary, and all six route node types (battle/elite/boss/rest/shop/capture_event).
