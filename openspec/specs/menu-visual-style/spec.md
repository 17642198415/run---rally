# menu-visual-style Specification

## Purpose

Defines Tier 1 menu page visual requirements for main menu, stage select, party setup, and bestiary view: shared card styling aligned with battle HUD, status-distinguishable stage cards, HERO highlight row, bestiary grid cells, and ArtLoader texture reuse. Campaign navigation and save logic remain unchanged.
